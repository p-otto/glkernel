...
//#define CHECK_CELLTYPE_EQUALITY(...) checkCelltypeEquality<__VA_ARGS__>()


//#define CHECK_CELLTYPE_EQUALITY(V1, V2, V3) static_assert(areSameCelltype<V1, V2, V3>(), KERNEL_CELLTYPE_NOT_MATCH_PARAM_CELLTYPES)
